...
if getgenv().Luminosity_Loaded and getgenv().Luminosity then
    getgenv().Luminosity:Destroy()
end

-- Set Globals --
getgenv().Luminosity_Loaded = true
getgenv().Luminosity = nil
...
getgenv().Luminosity = Luminosity.ScreenGui
